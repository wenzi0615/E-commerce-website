	...
	<body>
		...
		<div id="templatemo_wrapper">
			<div id="templatemo_header">
				...
				<div id="header_right">
					<a href="#">我的账户</a> | <a href="shoppingcart.jsp">我的购物车</a> | <a href="checkout.jsp">结算</a> | <a href="login.jsp">登录</a> | <a href="#">退出登录</a>
						...
						<table align="center">
							...
							<tr>
								...
								<td>
									...
									<input type="button" value="清空" onclick="clearPage()" />
								</td>
							</tr>
						</table>
