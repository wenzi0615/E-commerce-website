    ...
    <div id="templatemo_menu">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="checkout.jsp" class="selected">结算</a></li>
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
            ...
            <div class="content_half float_r checkout">
            	邮箱:
				<input type="text"  style="width:300px;"  name="e_mail"/>
                                         手机号码:<br />
				<span style="font-size:10px">请填写有效的手机号码. 你可能会被电话验证来完成这次交易.</span>
                <input type="text"  style="width:300px;"  name="phone"/>
            </div>
            
            <div class="cleaner h50"></div>
            <h3>购物车</h3>
            <h4>总计: <strong>￥<%=request.getParameter("total")%></strong></h4>
			<p><input type="checkbox" />我接受服务条款.</p>
            <center>
           		 <input type="hidden" name="total_price" value="<%=request.getParameter("total")%>"/>
            	<input type="submit" value="提交订单" align="middle">
            </center>
